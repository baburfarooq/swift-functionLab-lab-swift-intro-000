...
func personName(name: String){
 let personName = "Hello \(name)"
    print(personName)
}

personName(name: "Babur")
personName(name: "Jim")
personName(name: "Henory")
/*: question4
...
// write your code here
    ...
    var GREETING = "checking1"
    print("\(GREETING) WORL")
    
    GREETING = "GLUTEN TAD"
    print("\(GREETING) NEW FUN" )
}
